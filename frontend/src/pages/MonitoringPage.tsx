        ...
        <div className="work-layout">
          <section className="panel panel-pad">
            <div className="toolbar-card mb-4">
              <div>
                <h2 className="section-title">Sebaran Tahap Saat Ini</h2>
              ...
              {(sebaran ?? []).map((item) => (
                <div key={item.skema} className="rounded-lg border border-border p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <h3 className="section-title">Skema {item.skema}</h3>
                    <span className="badge">{item.stages.reduce((sum, stage) => sum + stage.total, 0)} aktif</span>
                  </div>
                    ...
                    {item.stages.map((stage) => (
                      <div key={stage.stage}>
                        ...
                        <div className="h-2 rounded bg-primary-tint">
                          <div className="h-2 rounded bg-primary" style={{ width: `${Math.max(4, (stage.total / maxStageTotal) * 100)}%` }} />
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <section className="panel panel-pad">
            <div className="toolbar-card mb-4">
              <div>
                <h2 className="section-title">Makloon Terdaftar</h2>
