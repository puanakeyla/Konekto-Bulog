...
export default function TransaksiDetailPage() {
   ...
   * tahap ini, dan sebelum recordnya lahir tidak ada tempat untuk menaruhnya.
   */
      ...
      <div className="relative mx-auto -mt-16 w-full max-w-[46rem] px-6 pb-16">
        <div className="panel p-4 sm:p-6">
          ...
          <div className="mb-5 overflow-hidden rounded-xl border border-border bg-gradient-to-br from-primary-tint to-white p-4">
            ...
            <p className="mt-2.5 text-xs leading-5 text-slate-500">Setiap tahap mengisi data, tahap berikutnya mengecek dengan aksi Terima atau Tolak. Pengadaan &amp; Keuangan dikerjakan langsung di sini.</p>
          </div>
