...
function kolomUntukRoleSkema(role: string, skema: 'TJP' | 'MPP'): SheetColumn<RekapTransaksi>[] {
  ...
  const stageCols = STAGE_ORDER.slice(0, batas + 1).flatMap((s): SheetColumn<RekapTransaksi>[] => {
    ...
    // MPP punya dua tahap makloon; hasil timbangnya kolom tersendiri di belakang data kirim.
    if (s === 'makloon') return skema === 'TJP' ? COLS_MAKLOON_TJP : [...COLS_MAKLOON_MPP, ...COLS_MAKLOON_TERIMA]
