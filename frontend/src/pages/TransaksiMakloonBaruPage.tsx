    ...
    <div className="page-shell">
      <div className="page-container-narrow">
        <header className="page-header">
          <div>
            <h1 className="page-title">Buat Baru (MPP)</h1>
            <p className="page-subtitle">Makloon membuat transaksi dan mengisi data bongkar.</p>
          </div>
          <span className="badge">Skema MPP</span>
        </header>
